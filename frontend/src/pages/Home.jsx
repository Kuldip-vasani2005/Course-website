  ...
  const features = [
    {
      ...
      description:
        "Complete courses at your own speed with lifetime access to course materials.",
    },
    {
      icon: "🏆",
      ...
      <section className="hero">
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p>
              Access hundreds of courses from industry experts. Learn anything,
              anytime, anywhere.
            </p>
